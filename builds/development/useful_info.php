...
<div class="page-titles-img title-space-xl bg-parallax parallax-overlay mb70" data-jarallax='{"speed": 0.2}' style='background-image: url("images/useful-info-bg.jpg");'>
	<div class="container">
		<div class="row">
			<div class=" col-md-8 ml-auto mr-auto">
				<h1 class='text-uppercase'>Useful Information</h1>
			</div>
		</div>
	</div>
</div><!--page title end-->
		...
		<div class="row pb60">
			<div class="col-md-4 mb30">
			   <div class="icon-box icon-box-center">
					...
					<h4>Starting Out:</h4>
					<p><i>This is an exciting time with lots to consider. It is important to:</i></p>
					<ol class="text-left">
						<li>Meet with your supervisor and explore our understanding of your PhD.</li>
						<li>Find time to meet other researchers in your field and across the University. Your peers will be invaluable to you throughout your research.</li>
						<li>Find out if your school is running an induction or look at the Welcome events.</li>
						<li>Develop a plan for your PhD and check if it is reasonable with your supervisor(s) and then get organised.</li>
					</ol>
				</div>
			</div>
			<div class="col-md-4 mb30">
			   <div class="icon-box icon-box-center">
					...
					<p><i>The middle of your PhD is a time to re-check your plans and review your expectations. It is important to:</i></p>
					<ol class="text-left">
						<li>Re-check your PhD plan, are your goals and priorities still appropriate?</li>
						<li>Think about conferences.</li>
						<li>Examine your skills: what courses would help you fully explore your research area?</li>
						<li>Regularly make back-ups of your notes and thesis saving copies to Dropbox, OneDrive, icloud, external hard drive or USB flash drive.</li>
					</ol>
				</div>
			</div><!--/col-->
			<div class="col-md-4 mb30">
			   <div class="icon-box icon-box-center">
					...
					<p><i>The end of your PhD is in sight. This period is about consolidating your results, writing your thesis and considering your future. It is important to:</i></p>
					<ol class="text-left">
						<li>Consider your future plans.</li>
						<li>Make sure your thesis writing ends up at the required deadline.</li>
						<li>Follow the University’s regulations for submission and understand the viva procedure.</li>
						<li>Prepare as much as possible for your viva.</li>
					</ol>
				</div>
			</div>
		</div>
...
<div class="container pt90 pb90">
	<div class="title-heading1 ">
		<h3>How to write my research proposal?</h3>
	</div>
			...
			<div class="row">
				<div class="col-lg-6 ">
					<ol>
						...
						<li>
							<h5>Abstract</h5>
							<p>In the abstract you need to clarify and state the problem that you want to examine or the central question that wish to address.</p>
						</li>
						<li>
							<h5>Research Overview (Introduction)</h5>
							<p>A well-written introduction is the most efficient way to hook your reader and set the context of your proposed research. An introduction should include a review of relevant literature and theories relating to your proposed research area with summarising the current state of knowledge and recent debates on the topic.</p>
						</li>
						<li>
							<h5>Objectives and Questions</h5>
							<p>Your research proposal should state clearly your research objectives and what is (are) the main question(s) that you want to answer at the end of your research. Your question(s) needs to be answerable within a set timeframe.</p>
						</li>
					</ol>
				</div>
				<div class="col-lg-6 ">
					<ol start="5">
						<li>
							<h5>Methodology</h5>
							<p>Present all research methods you intend to use throughout your research, e.g., techniques, sample size, equipment, data analysis, species choices, and explain why it is the most appropriate methodology to effectively answer the research questions.</p>
						</li>
						<li>
							<h5>Significance of Research</h5>
							<p>Discuss if your research will make an original contribution within your subject area.</p>
						</li>
						<li>
							<h5>Bibliography</h5>
							<p>Acknowledge ALL books, articles, journal papers, websites and all relevant references that you used to write your proposal.</p>
						</li>
					</ol>
					<p><i>You can still make changes to your research proposal once you have been accepted for a research degree, however as it is the foundation of your working relationship with your supervisor, it cannot be radically altered without discussion and consultation.</i></p>
				</div>
			</div>
		</div>
	</div>
